...
export function AuthPage() {
  ...
  return <AuthLayout><div className="auth-card">
    ...
    <form className="form" onSubmit={onSubmit} noValidate>
      ...
      <div className="form-row"><label className="remember"><input type="checkbox" defaultChecked /> <span>Remember device</span></label><a href="#forgot">Forgot password?</a></div>
