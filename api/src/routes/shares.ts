...
import { createShareHandler, getGuestSessionHandler, guestLogoutHandler, listSharesHandler, requestGuestOtpHandler, revokeShareHandler, verifyGuestOtpHandler } from '../controllers/share.controller.js';
...
shareRoutes.get('/shares/:token/session', getGuestSessionHandler);
